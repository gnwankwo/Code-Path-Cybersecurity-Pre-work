# Code Path Cybersecurity Pre-work: Basic Web Exploits
...
<img src='CyberSecuirty Prework submission.gif' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Took some time getting used to Burp but once I understood it. It was loads of fun to use to solve problems.
